...
const ToolsTechnologies = () => {
    return (
        <section id="tools" className="py-32 relative overflow-hidden" aria-label="Tools and Technologies">
            {/* Background Image */}
            <div 
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/58 to-black/60 pointer-events-none" aria-hidden="true" />
            ...
            <div className="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 justify-items-stretch" role="list">
