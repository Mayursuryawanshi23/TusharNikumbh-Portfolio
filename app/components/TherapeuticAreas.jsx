...
const TherapeuticAreas = () => {
    ...
    return (
        <section id="therapeuticareas" className="py-24 bg-slate-50/30 border-y border-slate-100 overflow-hidden" aria-label="Therapeutic Areas Experience">
            ...
            <div className="relative w-full overflow-hidden px-4 md:px-8">
                {/* Left Fade */}
                <div className="absolute left-0 top-0 bottom-0 w-28 bg-gradient-to-r from-white via-white to-transparent z-20 pointer-events-none" aria-hidden="true" />
                {/* Right Fade */}
                <div className="absolute right-0 top-0 bottom-0 w-28 bg-gradient-to-l from-white via-white to-transparent z-20 pointer-events-none" aria-hidden="true" />

                <div className="overflow-hidden">
                    <ul className="flex gap-6 items-stretch whitespace-nowrap scrolling" style={{ alignItems: 'stretch' }} role="list">
                        {duplicated.map((area, idx) => (
                            <li
                                ...
                                role="listitem"
                                aria-label={`${area.title} - ${area.phase} clinical trials`}
                            >
                                <div className="relative w-full h-32 overflow-hidden bg-slate-100">
                                    <img
                                        src={area.imageSrc}
                                        alt={`${area.title} therapeutic area`}
                                ...
                                <div className="p-4 h-24 flex flex-col justify-between">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        <div className="h-[1px] w-6 bg-slate-200 group-hover:bg-slate-400 transition-colors duration-200" aria-hidden="true" />
