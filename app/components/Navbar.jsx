    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 md:px-12 flex justify-between items-center">
                {/* Logo / Site Title */}
                <a href="/" className="font-serif text-2xl md:text-3xl font-bold tracking-tight text-slate-900" aria-label="Tushar Nikumbh - Principal Biostatistician">
                    Tushar Nikumbh
                </a>
                ...
                <div className="md:hidden">
                    <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                        ...
                        <SheetContent id="mobile-menu" side="right" className="w-[300px] sm:w-[400px]">
                            <nav className="flex flex-col gap-4 mt-8 px-4" role="menu">
                                {navLinks.map((link) => (
                                    <a
                                        key={link.name}
                                        href={link.href}
                                ...
                                <div className="pt-6 border-t border-slate-200 mt-2 space-y-3">
                                    <a href="/CV/Profile%20(1).pdf" target="_blank" rel="noopener noreferrer" onClick={() => setIsSheetOpen(false)} aria-label="Download CV (PDF)">
